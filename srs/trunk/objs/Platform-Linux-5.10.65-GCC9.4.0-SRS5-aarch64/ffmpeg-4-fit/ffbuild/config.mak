...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/mmc/srs/trunk/objs/Platform-Linux-5.10.65-GCC9.4.0-SRS5-aarch64/ffmpeg-4-fit/_release --pkg-config=pkg-config --pkg-config-flags=--static --extra-libs=-lpthread --extra-libs=-lm --disable-everything --disable-asm --disable-x86asm --disable-inline-asm --enable-decoder=libopus --enable-encoder=libopus --enable-libopus --disable-programs --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --disable-avformat --disable-swscale --disable-postproc --disable-avfilter --disable-network --disable-dct --disable-dwt --disable-error-resilience --disable-lsp --disable-lzo --disable-faan --disable-pixelutils --disable-hwaccels --disable-devices --disable-audiotoolbox --disable-videotoolbox --disable-cuvid --disable-d3d11va --disable-dxva2 --disable-ffnvcodec --disable-nvdec --disable-nvenc --disable-v4l2-m2m --disable-vaapi --disable-vdpau --disable-appkit --disable-coreimage --disable-avfoundation --disable-securetransport --disable-iconv --disable-lzma --disable-sdl2 --enable-decoder=aac --enable-decoder=aac_fixed --enable-decoder=aac_latm --enable-encoder=aac
...
CFLAGS=   -std=c11 -fomit-frame-pointer -fPIC -pthread  -I/home/mmc/srs/trunk/objs/Platform-Linux-5.10.65-GCC9.4.0-SRS5-aarch64/opus-1.3.1/_release/include/opus -I/home/mmc/srs/trunk/objs/Platform-Linux-5.10.65-GCC9.4.0-SRS5-aarch64/opus-1.3.1/_release/include/opus      -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
EXTRALIBS-avcodec=-pthread -lm -L/home/mmc/srs/trunk/objs/Platform-Linux-5.10.65-GCC9.4.0-SRS5-aarch64/opus-1.3.1/_release/lib -lopus -lm
EXTRALIBS-swresample=-lm
EXTRALIBS-avresample=-lm
EXTRALIBS-avutil=-pthread -lm -lXv -lX11 -lXext
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
